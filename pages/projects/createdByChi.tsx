  ...
  return (
    <div>
        ...
        <PageHeader
            ...
            projectDescription="I started an online platform called 'Created By Chi' to act as a space where I can share created content and resources for aspiring developers and designers. It's primarily a blog for some of my ideas on current tech and other forms of creative media, but I am also expanding it to provide courses and tutorials."
