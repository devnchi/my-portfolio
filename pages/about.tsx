    ...
    <div>
      ...
      <div className='bg-black p-20 mx-auto'>
        ...
        <div className='text-white md:text-xl font-spaceMono mx-auto md:p-16'>
          ...
          <p className='p-4'>Chi recently worked as an Associate Software Engineer at Corvus Insurance. With the desire to improve her skills and work on more interesting projects, she is actively doing freelance work as a developer, designer, and creative consultant through her business Qreative Agency.</p>
          <p className='p-4 text-2xl font-bold'>Chi's interests include:</p>
          <span className='font-comforterBrush text-4xl md:text-5xl mx-auto md:ml-4'> E-Commerce, Blockchain & Web3.0, Music, Fashion, Design, Marketing, Media, and Finance</span>
        </div>
      </div>
      <Footer />
    </div>
