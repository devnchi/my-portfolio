...
function Hero({}: Props) {
  ...
  return (
    <div className='container items-center text-center justify-center min-h-screen p-20 mt-20 lg:flex lg:text-justify lg:justify-evenly lg:max-w-8xl lg:mx-auto lg:mt-0'>
